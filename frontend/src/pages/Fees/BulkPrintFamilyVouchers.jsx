...
const FamilyVoucherSlip = ({ family, students, group, copyType, accounts = [] }) => {
        ...
        <div className="slip border border-gray-400 p-3 rounded-lg bg-white relative flex flex-col justify-between" style={{ width: '92mm', minHeight: '100%', fontSize: '9px' }}>
            <div className="overflow-hidden flex flex-col">
                ...
                <div className="bg-gray-50 p-1.5 rounded border border-gray-200 mb-2 text-[8px] leading-tight">
                    ...
                    <div className={`flex justify-between px-0.5 ${accounts.length > 0 ? 'border-t border-gray-100 pt-1 mt-1' : ''}`}>
                        <span className="font-bold underline text-[6.5px] uppercase">({String.fromCharCode(97 + accounts.length)}) Cash in office</span>
                    </div>
                </div>
