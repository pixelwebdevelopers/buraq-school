...
import { FaPlus, FaSearch, FaFilter, FaUserGraduate, FaIdCard, FaPhoneAlt, FaEdit, FaTrash, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
...
export default function Students() {
    ...
    const handleDeleteStudent = async (e, student) => {
        e.stopPropagation();
        if (window.confirm(`Are you sure you want to permanently delete student ${student.name}? This action cannot be undone.`)) {
            try {
